module decoder_8b_10b(
    ...
    assign code6 = code10[9:4];
    assign code4 = code10[3:0];

    reg code4_invalid;
    reg code6_invalid;

    assign code_invalid = (code4_invalid || code6_invalid) && !(is_k28_1);

    reg [4:0] data5;
    reg [2:0] data3;
    
    assign data = {data5, data3};
    ...
    always @ (*) begin
        ...
        if (code10 == 10'b001111_1001 || code10 == 10'b110000_0110)
            is_k28_1 = 1;
        else
            is_k28_1 = 0;
    end
